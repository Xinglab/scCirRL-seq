...
# gene_mtx_dir: gene matrix folder generated by NanoHunter, or a Seurat object
# feature_mtx_dir: gene/transcript matrix folder generated by NanoHunter, or Seurat object(s)
# .                either a folder or vector of folders(objects) with same length as feature_list/feature_label_list
