...
2. scRMATS-long: analysis modules for identification of cell type-specific and allele-specific splicing
...
scRMATS-long/NanoHunter was written in python3 and tested on Linux/Unix systems, so it may not work well with python2 and/or other systems(Windows/Mac).
