...
def parser_argv():
    ...
    parser.add_argument('bu_tsv', metavar='bc_umi.tsv', type=str, help='Output file of scCirRL main program, containing barcode, UMI, gene, transcript, and read information for each barcode-UMI pair')
